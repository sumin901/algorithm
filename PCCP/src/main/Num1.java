...
public class Num1 {
	 ...
	 * 최대 체력을 의미하는 정수 health, 몬스터의 공격 시간과 피해량을 담은 2차원 정수 배열 attacks가 
	...
	public int solution(int[] bandage, int health, int[][] attacks) {
        int answer = 0;
        int lastAttack = attacks[attacks.length][0]; // 마지막 공격 시간
        int sumTime = 0;
        int castTime = bandage[0];
        int healPerSec = bandage[1];
        int healBonus = bandage[2];
        
        // 어택 배열을 1차원 배열로 찢는게 편할까
        // 어택 2차원 배열 그대로 어떻게 사용할까?
